...
#
# Generated: Saturday 2. June 2018 08:55 WIB
# Hostname: localhost
...
#
# Data contents of table barang (6 records)
#
 
INSERT INTO `barang` VALUES ('BB00001', 'Buku', 2, 1500, 10, '0') ; 
INSERT INTO `barang` VALUES ('BB00002', 'Pena', 1, 1500, 17, '0') ; 
INSERT INTO `barang` VALUES ('BB00003', 'Silicone Alumunium Grey', 1, 5000, 18, '1') ; 
INSERT INTO `barang` VALUES ('BB00004', 'Silicone Black', 1, 2500, 5, '1') ; 
INSERT INTO `barang` VALUES ('BB00005', 'HP', 2, 3000, 11, '0') ; 
INSERT INTO `barang` VALUES ('BB00006', 'Leptop Core i3', 1, 0, 15, '0') ;
#
...
#
# Data contents of table barang_pembelian (4 records)
#
...
INSERT INTO `barang_pembelian` VALUES (110, 'BM00002', 'BB00003', 'Silicone Alumunium Grey', 'Pcs', '5000', 2, '10000', '0') ;
#
...
#
# Data contents of table d_pembelian (2 records)
#
 
INSERT INTO `d_pembelian` VALUES (1, 'BM00001', 'BB00001', '1500', 1, '1500') ; 
INSERT INTO `d_pembelian` VALUES (2, 'BM00002', 'BB00003', '5000', 2, '10000') ;
#
...
#
# Data contents of table d_penjualan (1 records)
#
 
INSERT INTO `d_penjualan` VALUES (27, 'INV00001', 'BB00002', '2000', 1, '3000') ;
#
...
#
# Delete any existing table `pegawai`
#
...
#
# Table structure of table `pegawai`
#
...
#
# Data contents of table pegawai (1 records)
#
 
INSERT INTO `pegawai` VALUES (4, 'Budi1', '082344451', 'budi1') ;
#
# End of data contents of table pegawai
# --------------------------------------------------------
...
#
# Data contents of table pembelian (2 records)
#
 
INSERT INTO `pembelian` VALUES ('BM00001', '2018-03-31', 6, 1, '1500') ; 
INSERT INTO `pembelian` VALUES ('BM00002', '2018-05-21', 6, 1, '10000') ;
#
...
#
# Data contents of table pembelian_update (2 records)
#
 
INSERT INTO `pembelian_update` VALUES (1, 'BM00001', 'BB00001', 1) ; 
INSERT INTO `pembelian_update` VALUES (2, 'BM00002', 'BB00003', 2) ;
#
...
#
# Data contents of table penjualan (1 records)
#
 
INSERT INTO `penjualan` VALUES ('INV00001', '2018-05-18', 6, 1, '1david', 1, 3300, '3000') ;
#
...
#
# Data contents of table penjualan_update (1 records)
#
 
INSERT INTO `penjualan_update` VALUES (39, 'INV00001', 'BB00002', 1) ;
#
...
INSERT INTO `supplier` VALUES (1, 'Agus makan', 'Toko Agus parah', '08234445', 'padang pasir') ; 
