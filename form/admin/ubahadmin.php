		...
		<div class="box">
			...
			<div class="box-body">	
				<?php
					...
					if (isset($_POST['save'])) {
						$admin->ubah_admin($_POST['email'],$_POST['pass'],$_POST['nama'],$_POST['sat'],$_FILES['gambar'],$_GET['id']);
				...
				<form method="POST" id="forminput" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select class="form-control" name="sat" id="sat">
							<option value="Pilih Satuan"><?php echo $adm['nama_level']; ?></option>
							<option value="">Pilih Level</option>
							<?php  
								$pl = $level->tampil_level();
								foreach ($pl as $index => $data) {
							?>
							<option  value="<?php echo $data['kd_level']; ?>" ><?php echo $data['nama_level']; ?></option>
							<?php  
								}
							?>
