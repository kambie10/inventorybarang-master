	...
	<div class="col-md-12">
		<div class="box">
			...
			<div class="box-body">	
				<?php 
					if (isset($_POST['save'])) {
						$supplier->ubah_supplier($_POST['nama'],$_POST['namatk'],$_POST['notlp'],$_POST['alamat'],$_GET['id']);
				...
				<form method="POST" id="forminput" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Toko</label>
						<input type="text" class="form-control" name="namatk" id="namatk" value="<?php echo $sp['nama_tk']; ?>" placeholder="Masukan Nama Toko">
					</div>
					<div class="form-group">
						<label>No Telpon</label>
						<input type="text" class="form-control" name="notlp" id="notlp" size="12" onkeypress="return isNumberKey(event)"  value="<?php echo $sp['notlp']; ?>" placeholder="Masukan Nama Supplier">
					</div>
					<div class="form-group">
						<label>Alamat</label>
