        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-bordered table-hover">
                    ...
                    <?php  
                        if (isset($_POST['prosess'])) {
                            ...
                            foreach ($lapbl as $index => $data) {
                                $hargabl1 = $data['subtotal'] / $data['jumlah']; 
                    ?>
                        <tr>
                            ...
                            <td>Rp. <?php echo number_format($hargabl1); ?></td>
                    ...
                    <?php
                        ...
                        elseif (isset($_POST['semua'])) {
                            ...
                            foreach ($lap as $index => $data) {
                                $hargabl = $data['subtotal'] / $data['jumlah']; 
                    ?>
                        <tr>
                            <td><?php echo $index + 1; ?></td>
                            <td><?php echo $data['kd_penjualan']; ?></td>
                            ...
                            <td><?php echo $data['jumlah']; ?></td>
                            <td>Rp. <?php echo number_format($hargabl); ?></td>
                            <td>Rp. <?php echo number_format($data['subtotal']); ?></td>
                        </tr>
                    <?php
                        }
                    ...
                    ?>
                        <tr>
                            <td colspan="7" align="center">Pilih Opsi Tampil</td>
                        </tr>
                        <tr>
                            <td colspan="6" align="center">TOTAL</td>
                            <td></td>
