                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                               ...
                               <!--  <td>Rp. <?php //echo number_format($data['total_penjualan']); ?></td> -->
                                <td>
                                    <a href="nota/cetaklaporansales.php?kdpenjualan=<?php echo $data['kd_penjualan']; ?>" target="_BLANK" class="btn btn-info btn-xs"><i class="fa fa-search"></i> Detail</a>
