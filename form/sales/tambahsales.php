	...
	<div class="col-md-12">
		<div class="box">
			...
			<div class="box-body">	
				<?php 
					if (isset($_POST['save'])) {
						$sales->simpan_sales($_POST['nama'],$_POST['notlp'],$_POST['alamat']);
				...
				<form method="POST" id="forminput" enctype="multipart/form-data">
					<div class="form-group">
						<label>Nama</label>
						<input type="text" style="text-transform:capitalize" class="form-control" name="nama" id="nama" placeholder="Masukan Nama">
					</div>
					<div class="form-group">
					...
					<a href="index.php?page=sales" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Back to Pelanggan</a>
				</form>
			</div>
		</div>
	</div>
