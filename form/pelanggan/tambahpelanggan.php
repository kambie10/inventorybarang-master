	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title" style="padding-top:0; margin-top:0; color:#f00;">Tambah Pelanggan</h3>
			</div>
			<hr/>
			<div class="box-body">	
				<?php 
					if (isset($_POST['save'])) {
						$pelanggan->simpan_pelanggan($_POST['nama'],$_POST['plg'],$_POST['notlp'],$_POST['alamat']);
				...
				<form method="POST" id="forminput" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" style="text-transform:capitalize" class="form-control" name="nama" id="nama" placeholder="Masukan Toko">
					</div>
					<div class="form-group">
						<label>Nama Pelanggan</label>
						<input type="text" style="text-transform:capitalize" class="form-control" name="plg" id="plg" placeholder="Masukan Pelanggan">
					</div>
					<div class="form-group">
