	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title" style="padding-top:0; margin-top:0; color:#f00;">Ubah Data Pegawai</h3>
			</div>
			<hr/>
			<div class="box-body">	
				<?php 
					if (isset($_POST['save'])) {
						$pegawai->ubah_pegawai($_POST['nama'],$_POST['notlp'],$_POST['alamat'],$_GET['id']);
						echo "<script>bootbox.alert('Data Terubah', function(){
							window.location = 'index.php?page=pegawai';
						});</script>";
					}
					$sp = $pegawai->ambil_pegawai($_GET['id']);
				?>	
				<form method="POST" id="forminput" enctype="multipart/form-data">
					<div class="form-group">
						<label>Nama Pegawai</label>
						<input type="text" style="text-transform:capitalize;" class="form-control" name="nama" id="nama" value="<?php echo $sp['nama_pegawai']; ?>">
					</div>
					<div class="form-group">
						<label>No Telpon</label>
						<input type="text" class="form-control" name="notlp" id="notlp" size="12" onkeypress="return isNumberKey(event)"  value="<?php echo $sp['no_telp']; ?>" >
					</div>
					<div class="form-group">
						<label>Alamat</label>
